...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-24  top-0 z-50 bg-transparent mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600">
      <div className='flex items-center gap-4 justify-center'>
        <img src="/image2.png" className='w-[50px] mr-2' alt="logo" />
        <div className='font-bold sm:text-xl lg:text-3xl'>{text}</div>
      </div>
      <div>
            ...
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">
                  I'm Hari Prasad J, Dedicated Software Engineer Trainee
